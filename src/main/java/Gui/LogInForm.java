...
public class LogInForm extends javax.swing.JFrame {
    ...
    private void confirmarButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_confirmarButtonMouseClicked
       ...
       if(dni.equals("") || contraseña.equals("")) throw new Exception("Empty fields");
       for(int i = 0; i < ControladorServicio.getClientes().size(); i++){
        if(ControladorServicio.getClientes().get(i).getDni().equalsIgnoreCase(dni) &&
           ControladorServicio.getClientes().get(i).getContraseña().equalsIgnoreCase(contraseña)){
           ControladorServicio.setClienteActual(ControladorServicio.getClientes().get(i).getDni());
           AppConcesionarioUI interfaz = new AppConcesionarioUI();
           interfaz.LoggedIn();
           interfaz.setVisible(true);
           this.setVisible(false);
